...
class OfferRepository {
    ...
    suspend fun createOffer(offer: Offer): ApiResponse<Offer> = api.createOffer(offer)

    suspend fun updateOffer(id: Int, offer: Offer): ApiResponse<Offer> = api.updateOffer(id, offer)

    suspend fun deleteOffer(id: Int?): ApiResponse<Unit> = api.deleteOffer(id)
}
